...
(function () {
	...
	app.load = function () {
		...
		app.Storage.Set = function (type = "string", key, data) {
			let _Storage = localStorage || window.localStorage;
	...
	$(window).on("sdlms:init:eagle", (event, data = {}) => {
		require(['sdlms/eaglebuilder'], function (eb) {
			console.log(eb);
			eb.init({
				tid: 2,
				log: true,
				...
				canControl: true,
				onChange: (data) => {
					socket.emit('meta.live.ebChange', data)
				},
				// onStart: (data) => { console.log(data) },
				// onPause: (data) => { console.log(data) },
				// onResume: (data) => { console.log(data) },
				// onResume: (data) => { localStorage.clear(),localStorage.setItem('EBT',Math.random()),localStorage.setItem('EB',JSON.stringify($f.clone()))},
				// onStart: (data) =>  { localStorage.clear(),localStorage.setItem('EBT',Math.random()),localStorage.setItem('EB',JSON.stringify($f.clone()))},
				// onPause: (data) =>  { localStorage.clear(),localStorage.setItem('EBT',Math.random()),localStorage.setItem('EB',JSON.stringify($f.clone()))},
				// onComplete: (data) =>  { localStorage.clear(),localStorage.setItem('EBT',Math.random()),localStorage.setItem('EB',JSON.stringify($f.clone()))},
				// onLock: (data) =>  { localStorage.clear(),localStorage.setItem('EBT',Math.random()),localStorage.setItem('EB',JSON.stringify($f.clone()))},
				// onComplete: (data) => { console.log(data) },
				// onExceed: (data) => { console.log(data) },
				// onLimit: (data) => { console.log(data) },
				// onLock: (data) => { console.log(data) },
				// onShow: (data) => { console.log(data) },
				// onHide: (data) => { console.log(data) },
				// onRender: (data) => { console.log(data) },
				// onDestroy: (data) => { console.log(data) },
				// onUpdate: (data) => { console.log(data) },
				// onResize: (data) => { console.log(data) },
				// onMove: (data) => { console.log(data) },
				// ifOnBreak: (data) => { console.log(data) },
				// sync:10
				// action: "builder",
				// target: ".eagleBuilder",
			})
